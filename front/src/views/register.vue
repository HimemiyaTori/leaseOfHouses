  ...
  <div>
    <div class="container">
      <div
        ...
        <h1 class="h1" style="color: rgba(0, 150, 136, 1); fontsize: 28px">
          房屋租赁管理系统注册
        </h1>
        <el-form
          ref="rgsForm"
          ...
          <el-form-item
            label="屋主账号"
            class="input"
            v-if="tableName == 'wuzhu'">
            <el-input
              v-model="ruleForm.wuzhuzhanghao"
              autocomplete="off"
              placeholder="屋主账号" />
          </el-form-item>
          <!-- <div v-if="tableName=='wuzhu'" class="input-group">
          ...
          <el-form-item
            ...
            v-if="tableName == 'wuzhu'">
            <el-input
              v-model="ruleForm.wuzhuxingming"
              autocomplete="off"
              placeholder="屋主姓名" />
          </el-form-item>
          <!-- <div v-if="tableName=='wuzhu'" class="input-group">
  ...
  methods: {
    ...
    login() {
      ...
      if (
        ...
        !this.$validate.isMobile(this.ruleForm.lianxifangshi)
      ) {
